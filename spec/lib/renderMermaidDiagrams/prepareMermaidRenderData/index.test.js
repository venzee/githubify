import prepareMermaidRenderData  from '<renderMermaidDiagrams>/prepareMermaidRenderData';
import path from 'path';

describe( 'The <renderMermaidDiagrams>/prepareMermaidRenderData function', ()=>{
