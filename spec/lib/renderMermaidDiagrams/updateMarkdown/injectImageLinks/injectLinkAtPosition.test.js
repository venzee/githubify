import createInjectLinkAtPosition from '<renderMermaidDiagrams>/updateMarkdown/injectImageLinks/injectLinkAtPosition'; // eslint-disable-line max-len

describe( 'The <renderMermaidDiagrams>/updateMarkdown/injectImageLinks function', ()=>{
