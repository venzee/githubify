import generateImageLinkText from '<tools>/githubify/renderMermaidDiagrams/prepareMermaidRenderData/generateImageLinkText'; // eslint-disable-line max-len
import path from 'path';

describe( 'The <tools>/githubify/renderMermaidDiagrams/prepareMermaidRenderData/generateImageLinkText function', ()=>{ // eslint-disable-line max-len
